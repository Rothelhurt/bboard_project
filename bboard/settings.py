...
SECRET_KEY = '9wvgzflf*02%j^a!g+wq-kc$(nq7_bqq25=y0!rd!2*jwc4m@r'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Мои обработчики контекста:
                'main.middlewares.bboard_context_processor',
            ],
        },
    },
]
# Настройки приложения cors_headers
...
SOCIAL_AUTH_VK_OAUTH2_KEY = '7300011'
SOCIAL_AUTH_VK_OAUTH2_SECRET = 'bFMzaCfERqI03GqFc5Yn'
